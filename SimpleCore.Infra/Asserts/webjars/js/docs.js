...
// 	        url : "http://petstore.swagger.io/v2/swagger.json",
        ...
        success: function (data) {
            ...
            $("[name='a_path']").click(function () {
                ...
                var apiData = jsonData.paths[path][method];

                apiData.path = path;
                apiData.method = method;
                var params = apiData.parameters;
                debugger
                var html = tempBody.render(apiData);
                $("#path-body").html(html);

                //如果没有返回值，直接跳过
                if (!apiData.responses["200"].hasOwnProperty("schema")) {
                    // continue
                    return true;
                }

                //基本类型
                if (apiData.responses["200"]["schema"].hasOwnProperty("type")) {
